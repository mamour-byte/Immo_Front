...
export default function SimilarProperties({ properties = [] }) {
  if (properties.length === 0) {
    return (
      <div className="mt-16">
        <h2 className="text-2xl font-bold text-text-main mb-8">Biens similaires</h2>
  ...
  return (
    <div className="mt-10 sm:mt-16">
      <h2 className="text-xl sm:text-2xl font-bold text-text-main mb-6 sm:mb-8">Biens similaires</h2>
